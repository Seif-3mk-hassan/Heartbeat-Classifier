"""
Quick test script for RBBB classification
"""
...
def plot_confusion_matrix(conf_matrix, labels, save_path='confusion_matrix.png'):
    ...
    plt.title('Confusion Matrix - RBBB Classification', fontsize=16, fontweight='bold')
...
def main():
    """Run ECG classification for RBBB"""
    print("="*60)
    print("ECG HEARTBEAT CLASSIFICATION - NORMAL vs RBBB")
    print("="*60)
    
    # Load dataset
    print("\n1. Loading dataset...")
    data_folder = r"d:\Data\Data\Normal&RBBB"
    dataset, label_map = load_dataset(data_folder, beat_types=['Normal', 'RBBB'])
    ...
    # Print results
    print("\n" + "="*60)
    print("CLASSIFICATION RESULTS - NORMAL vs RBBB")
    print("="*60)
    ...
    plot_confusion_matrix(conf_matrix, labels, 'confusion_matrix_RBBB.png')
